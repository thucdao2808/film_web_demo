...
const MovieAnime = ({ListMoieSingle}) => {
  const { img,title,titleExtra,year,paramater,director,time,type,statuss,country} = useParams();
    return (
        <div>
          <div className='separate'>
          <div className='demo-MovieAnime' >
               <div className='gallery-MovieAnime'>
                <img  className='img-MovieAnime' alt='' src={decodeURIComponent(img)}>
                   ...
                   <div className='selection-dowl-view'>
                    ...
                    <span className='views-film-MovieAnime'>
              ...
              <div className='content-film-MovieAnime'>
                  <h3 className='title-film-MovieAnime'>{decodeURIComponent(title)}</h3>
                  <span className='title-extra-film-MovieAnime' >{decodeURIComponent(titleExtra)}</span>
                  ...
                  <span className='time-film-MovieAnime'>Thời lượng:{decodeURIComponent(time)}</span>
             </div>
