...
const GasRefining = ({Movie}) => {
  const { img,title,titleExtra,year,paramater,time,type,statuss,country} = useParams();
    return (
        <div>
          <div className='separate'>
          <div className='demo-GasRefining' >
               <div className='gallery-GasRefining'>
                <img  className='img-GasRefining' alt='' src={decodeURIComponent(img)}>
                   ...
                   <div className='selection-dowl-view'>
                    ...
                    <span className='views-film-GasRefining'>
                        <FontAwesomeIcon icon={faCirclePlay} />Xem phim 
                    </span>
                  </div>
              </div>
              <div className='intro_part-film'>
              <div className='content-film-GasRefining'>
                  <h3 className='title-film-GasRefining'>{decodeURIComponent(title)}</h3>
                  <span className='title-extra-film-GasRefining' >{decodeURIComponent(titleExtra)}</span>
                  ...
                  <span className='time-film-GasRefining'>Thời lượng:{decodeURIComponent(time)}</span>
             </div>
